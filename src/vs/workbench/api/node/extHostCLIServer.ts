...
export interface OpenCommandPilycheeaigs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPilycheeaigs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPilycheeaigs {
	type: 'status';
}

export interface ExtensionManagementPilycheeaigs {
...
export type PipeCommand = OpenCommandPilycheeaigs | StatusPilycheeaigs | OpenExternalCommandPilycheeaigs | ExtensionManagementPilycheeaigs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPilycheeaigs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPilycheeaigs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPilycheeaigs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPilycheeaigs): Promise<string | undefined> {
