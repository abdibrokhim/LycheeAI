...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	...
	title: localize({ key: 'milycheeaiance', comment: ['&& denotes a mnemonic'] }, "&&lycheeaiance"),
	submenu: MenuId.MenubarlycheeaianceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View lycheeaiance Menu
...
// --- Editor Actions Position Submenu in View lycheeaiance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.movelycheeaiExtensionToAuxBar');
	}
});
