...
const openlycheeaiChat: WatermarkEntry = { text: localize('watermark.openlycheeaiChat', "Open Chat"), id: 'lycheeai.focusContinueInput', when: ContextKeyExpr.has('lycheeaiExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.lycheeaiBigChat', "Big Chat"), id: 'lycheeai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('lycheeaiExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.lycheeaiPrevChat', "Previous Chat"), id: 'lycheeai.loadRecentChat', when: ContextKeyExpr.has('lycheeaiExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('lycheeaiExtensionLoaded', true); // Set a context key when the lycheeai extension is loaded
