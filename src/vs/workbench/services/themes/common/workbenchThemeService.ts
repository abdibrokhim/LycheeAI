...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default lycheeai Dark',
	COLOR_THEME_LIGHT = 'Default lycheeai Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default lycheeai Dark',
	COLOR_THEME_LIGHT_OLD = 'Default lycheeai Light',
